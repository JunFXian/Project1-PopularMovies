...
public class ContentProviderFindIdAsyncTaskLoader extends AsyncTaskLoader<Cursor> {
    ...
    public ContentProviderFindIdAsyncTaskLoader(Context contextInfo, String movie)
    {
        super(contextInfo);
    ...
    public Cursor loadInBackground() {
        try {
//            String[] mProjection = new String[]{FavoriteMovieContract.FavoriteMovieEntry._ID};
